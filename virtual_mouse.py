...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		distances= math.sqrt(((finger_tip_x-thumb_tip_x)**2) + ((finger_tip_y-thumb_tip_y)**2))
		...
		r_m_x = (centre_x/width)*screen_width
		r_m_y = (centre_y/height)*screen_height
		mouse.position = (r_m_x,r_m_y)
